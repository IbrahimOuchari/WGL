...
class AccountStandardLedgerLines(models.TransientModel):
    ...
    cumul_balance = fields.Monetary(default=0.0, currency_field='company_currency_id', string='Balance Cumulée')
    ...
    current = fields.Monetary(default=0.0, currency_field='company_currency_id', string='Pas due')
    age_30_days = fields.Monetary(default=0.0, currency_field='company_currency_id', string='30 Jours')
    age_60_days = fields.Monetary(default=0.0, currency_field='company_currency_id', string='60 Jours')
    age_90_days = fields.Monetary(default=0.0, currency_field='company_currency_id', string='90 Jours')
    age_120_days = fields.Monetary(default=0.0, currency_field='company_currency_id', string='120 Jours')
    older = fields.Monetary(default=0.0, currency_field='company_currency_id', string='Plus Ancien')

    amount_currency = fields.Monetary(default=0.0, currency_field='currency_id', string='Montant Devise')
