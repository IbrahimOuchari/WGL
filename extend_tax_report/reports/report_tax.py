...
class ReportTax(models.AbstractModel):
    ...
    def _sql_from_amls_lines(self):
        sql = """SELECT "account_move_line".tax_line_id, "account_move_line__move_id".name, "account_move_line".credit, "account_move_line".debit, "account_move_line".date
                            FROM %s
                            WHERE %s AND "account_move_line".tax_exigible and "account_move_line".tax_line_id is not NULL"""
        return sql
