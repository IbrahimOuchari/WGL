...
class SaleOrder(models.Model):
    ...
    overdue_invoice_amount = fields.Monetary(
        ...
        help="Factures en souffrance montant résiduel total du partenaire de facturation dans la devise de l'entreprise.",
    )
    ...
    commercial_partner_invoicing_id = fields.Many2one(
        ...
        string="Partenaire Facturation Commerciale",
    )
