{
    ...
    'depends': ['base', 'base_setup', 'web_tour', 'web', 'calendar', 'sale_management', 'purchase', 'BMG_sale_starter',
                'report_xlsx', 'report_xlsx_helper', 'date_range', 'om_report_pdf_options', 'account'],
