...
class MailActivity(models.Model):
    ...
    res_id = fields.Many2oneReference(string='ID de Document Associé', index=True,
    ...
    recurring = fields.Boolean(string="Récurrent", store=True)
    ...
    interval = fields.Selection(
        [('Daily', 'Daily'),
         ...
         ('Quarterly', 'Quarterly'),
         ('Yearly', 'Yearly')],
        string='Interval récurrent', )
    new_date = fields.Date(string="Prochaine Date d'Echéance", store=True)
