...
class SaleOrderUpdate(models.Model):
	...
	invoiced_amount = fields.Float(String='Montant Facturé',compute='_compute_invoice_amount')
	amount_due = fields.Float(String='Montant Dû',compute='_compute_amount_due')
	paid_amount = fields.Float(String='Montant Payé',compute='_compute_amount_paid')
